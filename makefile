...
form: src/main.c src/login_box.c src/draw.c src/draw.h src/login_box.h
	gcc -g src/main.c src/login_box.c src/draw.c src/util.h src/draw.h src/login_box.h -o tui-dm -lncurses -lform -Wall
